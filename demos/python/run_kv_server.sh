...
export PYTHONPATH=$BASEFOLDER/$FACDCLSPTH:$BASEFOLDER/kv:$BASEFOLDER/$PROTOCLSPTH:$BASEFOLDER/../../protobuf/build/lib/python2.7/site-packages

echo
echo

$BASEFOLDER/kv/launcher.py "-Djava.class.path=$BASEFOLDER/../../bftsmart/bin/BFT-SMaRt.jar:"\
