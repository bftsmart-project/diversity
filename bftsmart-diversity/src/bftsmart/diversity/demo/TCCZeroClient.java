...
public class TCCZeroClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < numThreads; i++) {
            ...
            c[i] = new TCCZeroClient.Client(initId + i, numberOfOps, interval, max, verbose, parallel, percent, opSel);
            //c[i].start();
        }
        ...
        public void run() {
            ...
            for (int i = 0; i <  
                ...
                int op = Math.abs(this.opSelecionada*10 - 35)!=15? 
                   ...
                   VazioOuterClass.Vazio reqst = VazioOuterClass.Vazio
                        .newBuilder()
                        .build();
