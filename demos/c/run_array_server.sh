...
[ $# -eq 0 ] && { echo "Usage: $0 config_folder id_replica respsize interval"; exit 1; }
...
$BASEFOLDER/array/build/bench_server.out $1 "-Djava.class.path=$BASEFOLDER/../../bftsmart/bin/BFT-SMaRt.jar:"\
...
"$BASEFOLDER/$DIVCLSPTH/bftsmart-diversity.jar" $2 $3
