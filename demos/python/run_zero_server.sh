...
PROTOCLSPTH=../protobuf/zero/build
...
export PYTHONPATH=$BASEFOLDER/$FACDCLSPTH:$BASEFOLDER/zero:$BASEFOLDER/$PROTOCLSPTH:$BASEFOLDER/../../protobuf/build/lib/python2.7/site-packages

echo
echo

$BASEFOLDER/zero/demolist.py "-Djava.class.path=$BASEFOLDER/../../bftsmart/bin/BFT-SMaRt.jar:"\
...
"$BASEFOLDER/$DIVCLSPTH/bftsmart-diversity.jar" $1 $BASEFOLDER/$DLLCLSPTH
