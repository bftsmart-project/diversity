 ...
 * @author caio
 */
public class TCCListClientPure {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < numThreads; i++) {
            ...
            c[i] = new TCCListClientPure.Client(initId + i, numberOfOps, interval, max, verbose, parallel, percent, opSel);
            //c[i].start();
        }
        ...
        public void run() {
            ...
            for (int i = 0; i <  
                ...
                if (op == TipoRequest.ADD) {
                    ...
                    DataOutputStream  dos = new DataOutputStream (os);
                    try {
                    dos.writeInt(TipoRequest.CONTAINS);
                    dos.writeInt(index);
...
ByteArrayOutputStream os = new ByteArrayOutputStream();
                    DataOutputStream  dos = new DataOutputStream (os);
                    try {
                    dos.writeInt(TipoRequest.REMOVE);
                    dos.writeInt(index);
