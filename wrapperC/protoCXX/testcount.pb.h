...
#ifndef PROTOBUF_testcount_2eproto__INCLUDED
#define PROTOBUF_testcount_2eproto__INCLUDED
...
class Counter : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_testcount_2eproto();
  friend void protobuf_AssignDesc_testcount_2eproto();
  friend void protobuf_ShutdownFile_testcount_2eproto();
...
inline ::google::protobuf::int32 Counter::value() const {
  // @@protoc_insertion_point(field_get:Counter.value)
  return value_;
}
inline void Counter::set_value(::google::protobuf::int32 value) {
  set_has_value();
  value_ = value;
...
#endif  // PROTOBUF_testcount_2eproto__INCLUDED
